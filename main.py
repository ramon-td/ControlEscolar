...
alumno_materia_optionMenu.grid(column=4, columnspan=1, row=4, padx=10, pady=10, sticky=tk.E)
alumno_materia_optionMenu.configure(width=8)
...
maestro_carrera_optionMenu.grid(column=4, columnspan=1, row=2, padx=10, pady=10, sticky=tk.E)
maestro_carrera_optionMenu.configure(width=16)
maestro_materia_optionMenu.grid(column=4, columnspan=1, row=3, padx=10, pady=10, sticky=tk.E)
maestro_materia_optionMenu.configure(width=16)
maestro_grado_optionMenu.grid(column=4, columnspan=1, row=5, padx=10, pady=10, sticky=tk.E)
...
materia_carrera_optionMenu.grid(column=4, columnspan=1, row=2, padx=10, pady=10, sticky=tk.E)
...
#- - - - - - - - - - - - - - - - - - - - - - - Entries y etiquetas - - - - - - - - - - - - - - - - - - - -
horario_code_label = tk.Label(pestana_horario, text="Ingrese codigo de Materia: ")
...
#- - - - - - - - - - - - - - - - - - - - - - - - - - Posiciones - - - - - - - - - - - - - - - - - - - - - - -
horario_code_label.grid(column=1, columnspan=2, row=0, padx=10, pady=10, sticky=tk.E)
horario_id_label.grid(column=1, columnspan=1, row=1, padx=10, pady=10, sticky=tk.E)
horario_turno_label.grid(column=1, columnspan=1, row=2, padx=10, pady=10, sticky=tk.E)
horario_code_entry.grid(column=3, columnspan=2, row=0, padx=10, pady=10, sticky=tk.W)
horario_code_entry.configure(width=30)
horario_id_entry.grid(column=2, columnspan=2, row=1, padx=10, pady=10, sticky=tk.W)
horario_id_entry.configure(width=15)
horario_turno_optionMenu.grid(column=2, columnspan=1, row=2, padx=10, pady=10, sticky=tk.E)
horario_turno_optionMenu.configure(width=8)
horario_hora_label.grid(column=3, columnspan=1, row=2, padx=10, pady=10, sticky=tk.E)
horario_hora_optionMenu.grid(column=4, columnspan=1, row=2, padx=10, pady=10, sticky=tk.E)
horario_hora_optionMenu.configure(width=8)



horario_buscar_btn.grid(column=5, columnspan=1, row=0, padx=10, pady=10, sticky=tk.E)
...
#- - - - - - - - - - - - - - - - - - - - - - - Entries y etiquetas - - - - - - - - - - - - - - - - - - - -
salon_code_label = tk.Label(pestana_salon, text="Ingrese codigo de Materia: ")
...
#- - - - - - - - - - - - - - - - - - - - - - - Entries y etiquetas - - - - - - - - - - - - - - - - - - - -
carrera_code_label = tk.Label(pestana_carrera, text="Ingrese codigo de Materia: ")
...
carrera_materia_optionMenu.grid(column=2, columnspan=1, row=4, padx=10, pady=10, sticky=tk.E)
carrera_materia_optionMenu.configure(width=8)
